...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            // Verifica se há dados já existentes
            ...
            Department d1 = new Department(1, "manufacturing");
            Department d2 = new Department(2, "sales");
            Department d3 = new Department(3, "investigative");
            Department d4 = new Department(4, "legal");

            //Adiciona vendedores
            Seller s1 = new Seller(1, "Walter White", "walter@gmail.com", new DateTime(1958, 7, 09), 1000.0, d1);
            ...
            // Adiciona departamentos ao banco de dados
            _context.Department.AddRange(d1, d2, d3, d4);
            // Adiciona vendedores ao banco de dados
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);
            // Adiciona vendas ao banco de dados
